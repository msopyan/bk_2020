...
<head>
<meta charset="utf-8">
<link rel="shorcut icon" type="text/css" href="assets/images/favicon.ico">
...
<body>
	<div id="fh5co-page">
	<header id="fh5co-error" role="banner">
		<div class="container">
			<div class="header-inner">
				<a href="" title="Go to Home"><img alt="bk logo" class="logo" src="assets/images/mylogo.svg"></a>
				<nav role="navigation">
					<ul>
	...
	<aside id="#fh5co-error-hero" class="js-fullheight">
      			...
      			<div class="row">
        			<div class="column-66" >
          				<div class="slider-text-inner">
	   						<h3 class="main-error-title">We think you get lost.</h3>
							<p class="sub-error-title">There is no route found, please check your </p>  
							<p class="sub-mini-error-title">Destination again.</p>
							<p><a href="" class="btn btn-primary btn-lg">Beranda</a></p>		   
						</div>
					</div>
					<div class="column-33">
         				<img src="theme/images/404-Lost.png" class="img-error" >
       				</div>
				</div>
			</div>
		</div>
